...
export const metadata: Metadata = {
  title: "سوشی گالری کوروش مال",
  description: "منوی کامل سوشی گالری کوروش مال — سوشی، رول، نودل، سوپ و غذاهای آسیایی",
  openGraph: { title: "سوشی گالری کوروش مال" },
};

export default function SushiPage() {
  const brand = getBrand("sushi-gallery")!;
  const items = getItemsByBrand("sushi-gallery");
