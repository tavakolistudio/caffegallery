...
export const metadata: Metadata = {
  title: "پاستا گالری کوروش مال",
  description: "منوی کامل پاستا گالری کوروش مال — پاستا، سالاد و پیش‌غذا",
  openGraph: { title: "پاستا گالری کوروش مال" },
};

export default function PastaPage() {
  const brand = getBrand("pasta-gallery")!;
  const items = getItemsByBrand("pasta-gallery");
